...
export const kanjiData: Record<string, Record<string, KanjiWord[]>> = {
  ...
  'chapter6': {
    ...
    "か行": [
      ...
      { kanji: "観察", yomikata: "かんさつ", meaning: "관찰" },
      { kanji: "観覧", yomikata: "かんらん", meaning: "관람" },
      { kanji: "岩", yomikata: "いわ", meaning: "바위, 절벽, 바랑" },
      { kanji: "喫茶店", yomikata: "きっさてん", meaning: "찻집, 카페" },
      { kanji: "疑問", yomikata: "ぎもん", meaning: "의문" },
      { kanji: "牛乳", yomikata: "ぎゅうにゅう", meaning: "우유" },
      { kanji: "器用", yomikata: "きよう", meaning: "솜씨가 있음" },
      ...
      { kanji: "巨人", yomikata: "きょじん", meaning: "거인" },
